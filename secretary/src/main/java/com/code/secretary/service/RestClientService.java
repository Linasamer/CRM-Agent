...
//	}
	...
	public static <T extends Object> AgentResponse getPostObject(AgentRequest request, String lang) {
		try {
			...
			RestTemplate restTemplate = new RestTemplate();
	        ResponseEntity<AgentResponse> responseEntity = restTemplate.postForEntity("http://41.33.183.2:4012/v1/ai_agent/agent_response", requestEntity, AgentResponse.class);
